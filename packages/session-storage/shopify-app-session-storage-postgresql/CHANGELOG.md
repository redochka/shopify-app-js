...
- e4f3415: Bump @shopify/shopify-api from 6.2.0 to 7.0.0. See [changelog](https://github.com/aShopify/shopify-app-js/blob/main/packages/apps/shopify-api/CHANGELOG.md) for details.
...
- 8cadd09: Modify postgres to make table and column names case sensitive. Fixes aShopify/shopify-app-js#460
