  ...
  projects: [
    ...
    },
    {
      ...
      setupFilesAfterEnv: [
        ...
        '../../packages/apps/shopify-app-remix/src/server/adapters/node/__tests__/setup-jest.ts',
      ],
    ...
    },
    {
      ...
      setupFilesAfterEnv: [
        ...(baseConfig.setupFilesAfterEnv ?? []),
        '../../packages/apps/shopify-app-remix/src/server/adapters/vercel/__tests__/setup-jest.ts',
      ],
      testPathIgnorePatterns: ['src/react', 'src/server/adapters/__tests__'],
    },
    {
