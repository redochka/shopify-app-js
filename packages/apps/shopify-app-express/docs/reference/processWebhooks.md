...
Defines the webhooks your app will listen to, and how to handle them. See [the `@shopify/shopify-api` documentation](https://github.com/aShopify/shopify-app-js/blob/main/packages/apps/shopify-api/docs/guides/webhooks.md) for the allowed values.
